...
for i=1,#rulexml.Queue.item do
	table.insert( queueruledata, rulexml.Queue.item[i]:value() )
end
...
--規則類型(重度)
	...
	if(lang == "Japan") then
		categorytitleText.text = langxml.XnaContent.Japan.Punishment[4]:value()
	...
	elseif lang == "Korea" then
		categorytitleText.text = langxml.XnaContent.Korea.Punishment[4]:value()
		...
		sceneGroup:insert( nextstepruleButton )
	elseif lang == "China" then
		categorytitleText.text = langxml.XnaContent.China.Punishment[4]:value()
	...
	elseif lang == "Spain" then
		...
		categorytitleText.text = langxml.XnaContent.Spain.Punishment[4]:value()
		...
		sceneGroup:insert( nextstepruleButton )
	elseif lang == "Taiwan" then
		categorytitleText.text = langxml.XnaContent.Taiwan.Punishment[4]:value()
	...
	elseif lang == "America" then
		categorytitleText.text = langxml.XnaContent.America.Punishment[4]:value()
		...
		sceneGroup:insert( nextstepruleButton )
	elseif lang == "France" then
		categorytitleText.text = langxml.XnaContent.France.Punishment[4]:value()
		...
		sceneGroup:insert( nextstepruleButton )
	elseif lang == "Germany" then
		categorytitleText.text = langxml.XnaContent.Germany.Punishment[4]:value()
		...
		sceneGroup:insert( nextstepruleButton )
	elseif lang == "Malaysia" then
		categorytitleText.text = langxml.XnaContent.Malaysia.Punishment[4]:value()
		...
		sceneGroup:insert( nextstepruleButton )
	elseif lang == "Russia" then
		categorytitleText.text = langxml.XnaContent.Russia.Punishment[4]:value()
		...
		sceneGroup:insert( nextstepruleButton )
	elseif lang == "Vientnames" then
		categorytitleText.text = langxml.XnaContent.Vientnames.Punishment[4]:value()
		...
		sceneGroup:insert( nextstepruleButton )
	elseif lang == "Dutch" then
		categorytitleText.text = langxml.XnaContent.Dutch.Punishment[4]:value()
		...
		sceneGroup:insert( nextstepruleButton )
	elseif lang == "Italy" then
		categorytitleText.text = langxml.XnaContent.Italy.Punishment[4]:value()
...
--加入家庭類選項
	...
	function onRowRender( event )
	    ...
	    queuerulecontent = display.newText( "",0 , 0, native.systemFontBold, 14 )
		queuerulecontent.align = "left"
		queuerulecontent:setFillColor( 0, 0, 0 )
		--testarray = rulexml.Queue.item[rowIndex]:value()
		queuerulecontent.text = queueruledata[rowIndex]
		print(queueruledata[1])
		--文字靠左
		queuerulecontent.anchorX = 0
	    queuerulecontent.x = row_ContentWidth * 0.15
	    queuerulecontent.y = row_ContentHeight * 0.5
	    ...
	    --print(event.phase)
	   	if event.phase == "press" then
	    	...
	    	if (rulenotexist == false) then
		    	table.insert( queuerulecount, rowIndex)
				print(rulexml.Queue.item[rowIndex]:value())
			end
			rulenotexist = false
		end
